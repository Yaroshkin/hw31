...
with Session(engine) as session:
    ...
    teach1 = Teacher(name="Иван", surname="Середа", salary=1200, dataofemployment="12.08.1998", position="Професор",isassistent=0, isproffessor=1, premium=0)
    teach2 = Teacher(name="Антон", surname="Ганжа", salary=1050, dataofemployment="10.03.2001", position="Ассистент",isassistent=1, isproffessor=0, premium=0,groups=groups1)
